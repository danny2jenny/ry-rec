...
CREATE TABLE IF NOT EXISTS `actionrule` (
  ...
  `device` int(10) unsigned NOT NULL COMMENT '源设备',
  `sig` int(10) NOT NULL COMMENT '源信号',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `channel` (
  ...
  `ip` varchar(50) DEFAULT NULL COMMENT 'IP地址，或者URL',
  `port` int(11) NOT NULL DEFAULT 0 COMMENT '端口号',
  `login` varchar(50) DEFAULT NULL COMMENT '登录名',
  `pass` varchar(50) DEFAULT NULL COMMENT '密码',
  `type` int(10) unsigned NOT NULL DEFAULT 1 COMMENT '通道类型',
  `opt` varchar(1024) DEFAULT NULL COMMENT '通道配置',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='通道表，主要用于描述网络通道。主要用于保存可以连接的信息。';

-- 正在导出表  ryrec.channel 的数据：~0 rows (大约)
...
CREATE TABLE `channelnode` (
	...
	`ip` VARCHAR(50) NULL COMMENT 'IP地址，或者URL' COLLATE 'utf8_general_ci',
	`port` INT(11) NOT NULL COMMENT '端口号',
	`login` VARCHAR(50) NULL COMMENT '登录名' COLLATE 'utf8_general_ci',
	`pass` VARCHAR(50) NULL COMMENT '密码' COLLATE 'utf8_general_ci',
	`ctype` INT(10) UNSIGNED NOT NULL COMMENT '通道类型',
	`channelConf` VARCHAR(1024) NULL COMMENT '通道配置' COLLATE 'utf8_general_ci',
	`nid` INT(10) UNSIGNED NULL COMMENT '设备的唯一编号',
	`adr` INT(10) UNSIGNED NULL COMMENT '485地址',
	`no` INT(10) UNSIGNED NULL COMMENT '485设备内的地址',
	`nname` VARCHAR(200) NULL COMMENT '名称' COLLATE 'utf8_general_ci',
	`ntype` INT(10) UNSIGNED NULL COMMENT '类型',
	`nodeConf` VARCHAR(1024) NULL COMMENT '配置信息Json' COLLATE 'utf8_general_ci',
	`device` INT(10) UNSIGNED NULL COMMENT '对应设备',
	`deviceFun` INT(10) UNSIGNED NULL COMMENT '对应设备编号',
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` EVENT `del_alarm` ON SCHEDULE EVERY 1 DAY STARTS '2018-01-15 00:00:00' ON COMPLETION PRESERVE ENABLE COMMENT '定时删除告警' DO BEGIN
...
CREATE TABLE IF NOT EXISTS `device` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `no` int(10) unsigned NOT NULL COMMENT '编号，备用',
...
CREATE TABLE `devicegis` (
	...
	`dno` INT(10) UNSIGNED NOT NULL COMMENT '编号，备用',
	`dname` VARCHAR(50) NULL COMMENT '名称' COLLATE 'utf8_general_ci',
	`dtype` INT(10) UNSIGNED NOT NULL COMMENT '类型',
	`icon` INT(10) UNSIGNED NOT NULL COMMENT '图标',
...
CREATE TABLE `devicenode` (
	...
	`dtype` INT(10) UNSIGNED NOT NULL COMMENT '类型',
	`nid` INT(10) UNSIGNED NULL COMMENT '设备的唯一编号',
	`cid` INT(10) UNSIGNED NULL COMMENT '对应通道',
	`nadd` INT(10) UNSIGNED NULL COMMENT '485地址',
	`nno` INT(10) UNSIGNED NULL COMMENT '485设备内的地址',
	`ntype` INT(10) UNSIGNED NULL COMMENT '类型',
	`conf` VARCHAR(1024) NULL COMMENT '配置信息Json' COLLATE 'utf8_general_ci',
	`nfun` INT(10) UNSIGNED NULL COMMENT '对应设备编号'
) ENGINE=MyISAM;
...
CREATE TABLE IF NOT EXISTS `gis` (
  ...
  `device` int(10) unsigned NOT NULL COMMENT '关联设备',
  `type` int(10) unsigned NOT NULL COMMENT '点线面的类型',
  `layer` int(10) unsigned NOT NULL COMMENT '在那一层',
  `data` varchar(1024) DEFAULT '0' COMMENT '具体的空间数据',
  `style` int(11) unsigned NOT NULL COMMENT '渲染风格，目前没用',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `gislayer` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(254) NOT NULL DEFAULT '图层名称' COMMENT '图层名称',
  `file` varchar(254) DEFAULT '图片位置' COMMENT '文件名',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `node` (
  ...
  `cid` int(10) unsigned NOT NULL COMMENT '对应通道',
  `adr` int(10) unsigned NOT NULL COMMENT '485地址',
  `no` int(10) unsigned NOT NULL COMMENT '485设备内的地址',
  `name` varchar(200) NOT NULL COMMENT '名称',
  `type` int(10) unsigned NOT NULL COMMENT '类型',
  `opt` varchar(1024) DEFAULT NULL COMMENT '配置信息Json',
  `device` int(10) unsigned NOT NULL COMMENT '对应设备',
  `deviceFun` int(10) unsigned NOT NULL COMMENT '对应设备编号',
  `enable` tinyint(3) unsigned NOT NULL DEFAULT 1,
  `addr104` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
